...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? lastName,  String? firstName,  int? schoolId,  SchoolModel? school,  int? schoolYear,  String schoolTrailing,  String schoolYearTrailing,  List<SchoolModel> schools,  List<String> schoolYears,  String? nameErrorState,  String? schoolErrorState,  bool authorized)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignupState() when $default != null:
return $default(_that.lastName,_that.firstName,_that.schoolId,_that.school,_that.schoolYear,_that.schoolTrailing,_that.schoolYearTrailing,_that.schools,_that.schoolYears,_that.nameErrorState,_that.schoolErrorState,_that.authorized);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? lastName,  String? firstName,  int? schoolId,  SchoolModel? school,  int? schoolYear,  String schoolTrailing,  String schoolYearTrailing,  List<SchoolModel> schools,  List<String> schoolYears,  String? nameErrorState,  String? schoolErrorState,  bool authorized)  $default,) {final _that = this;
switch (_that) {
case _SignupState():
return $default(_that.lastName,_that.firstName,_that.schoolId,_that.school,_that.schoolYear,_that.schoolTrailing,_that.schoolYearTrailing,_that.schools,_that.schoolYears,_that.nameErrorState,_that.schoolErrorState,_that.authorized);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? lastName,  String? firstName,  int? schoolId,  SchoolModel? school,  int? schoolYear,  String schoolTrailing,  String schoolYearTrailing,  List<SchoolModel> schools,  List<String> schoolYears,  String? nameErrorState,  String? schoolErrorState,  bool authorized)?  $default,) {final _that = this;
switch (_that) {
case _SignupState() when $default != null:
return $default(_that.lastName,_that.firstName,_that.schoolId,_that.school,_that.schoolYear,_that.schoolTrailing,_that.schoolYearTrailing,_that.schools,_that.schoolYears,_that.nameErrorState,_that.schoolErrorState,_that.authorized);case _:
  return null;
