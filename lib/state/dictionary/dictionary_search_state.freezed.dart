...
/// Adds pattern-matching-related methods to [DictionarySearchState].
extension DictionarySearchStatePatterns on DictionarySearchState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _DictionarySearchState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _DictionarySearchState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _DictionarySearchState value)  $default,){
final _that = this;
switch (_that) {
case _DictionarySearchState():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _DictionarySearchState value)?  $default,){
final _that = this;
switch (_that) {
case _DictionarySearchState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TextEditingController searchBarTextController,  List<DictionaryItemModel> searchedItems)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DictionarySearchState() when $default != null:
return $default(_that.searchBarTextController,_that.searchedItems);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TextEditingController searchBarTextController,  List<DictionaryItemModel> searchedItems)  $default,) {final _that = this;
switch (_that) {
case _DictionarySearchState():
return $default(_that.searchBarTextController,_that.searchedItems);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TextEditingController searchBarTextController,  List<DictionaryItemModel> searchedItems)?  $default,) {final _that = this;
switch (_that) {
case _DictionarySearchState() when $default != null:
return $default(_that.searchBarTextController,_that.searchedItems);case _:
  return null;
