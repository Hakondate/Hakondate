...
@freezed
abstract class OriginItemModel with _$OriginItemModel {
  const factory OriginItemModel({required String name, required List<String> prefectures}) = _OriginItemModel;
  ...
  factory OriginItemModel.fromFirestore(MapEntry<String, dynamic> item) {
    ...
    return OriginItemModel(name: item.key, prefectures: prefectures);
  }

  Map<String, Object> toFirestore() => <String, Object>{name: prefectures};
}
