...
/// Adds pattern-matching-related methods to [FoodstuffModel].
extension FoodstuffModelPatterns on FoodstuffModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FoodstuffModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FoodstuffModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FoodstuffModel value)  $default,){
final _that = this;
switch (_that) {
case _FoodstuffModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FoodstuffModel value)?  $default,){
final _that = this;
switch (_that) {
case _FoodstuffModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  QuantityModel quantity,  NutrientsModel nutrients,  bool isAllergy,  bool isHeat,  String? origin)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FoodstuffModel() when $default != null:
return $default(_that.name,_that.quantity,_that.nutrients,_that.isAllergy,_that.isHeat,_that.origin);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  QuantityModel quantity,  NutrientsModel nutrients,  bool isAllergy,  bool isHeat,  String? origin)  $default,) {final _that = this;
switch (_that) {
case _FoodstuffModel():
return $default(_that.name,_that.quantity,_that.nutrients,_that.isAllergy,_that.isHeat,_that.origin);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  QuantityModel quantity,  NutrientsModel nutrients,  bool isAllergy,  bool isHeat,  String? origin)?  $default,) {final _that = this;
switch (_that) {
case _FoodstuffModel() when $default != null:
return $default(_that.name,_that.quantity,_that.nutrients,_that.isAllergy,_that.isHeat,_that.origin);case _:
  return null;
