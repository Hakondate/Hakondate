...
class ConnectionExceptionDialog extends StatelessWidget {
  const ConnectionExceptionDialog({super.key, this.onTapRetry, this.onTapContinue});
  ...
  Widget build(BuildContext context) {
    ...
    return HakondateDialog(
      ...
      firstAction: HakondateActionButton.primary(text: const Text('リトライ'), onTap: onTapRetry),
      secondAction: HakondateActionButton(text: const Text('このまま利用'), onTap: onTapContinue),
    );
  }
}
