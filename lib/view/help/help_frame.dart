...
class HelpFrame extends StatelessWidget {
          ...
          children: <Widget>[
            ...
            Consumer(
              builder: (_, WidgetRef ref, __) {
                final AsyncValue<HelpState> state =
                    ref.watch(helpViewModelProvider);
                return state.when(
  ...
  factory HelpFrame.recommendedIngredients() => HelpFrame(
        ...
        content: DescriptionText.body(
            label:
                '　オススメ食材は，5大栄養素の内，最も不足している栄養素と次に不足している栄養素が多く含まれる食材を表示しています．また，給食が休みの日は表示されません．',),
      );
  ...
  static Widget _iconWithText(String text, IconData icon) {
    return Padding(
