...
class UnauthorizedDayBody extends StatelessWidget {
  const UnauthorizedDayBody({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: Column(
        ...
        children: <Widget>[
          Image.asset('assets/images/status/menu_status/holiday.png', width: screenWidth / 2),
          ...
          ElevatedButton(
            ...
            child: const Text('入力する', style: TextStyle(fontWeight: FontWeight.bold)),
            onPressed: () async {
