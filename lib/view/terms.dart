...
class Terms extends ConsumerWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _paragraphText(
                  title: '第三条 利用上の注意',
                  paragraphSentence: '　本アプリで提供する情報は，完全性を保証するものではありません．'
              ...
              _paragraphText(
                  ...
                  paragraphSentence:
                      ...
                      'これにより，利用者または第三者が被った損害に対し提供者はいかなる責任も追わないものとし，損害賠償の義務もないものとします．'
  ...
  Widget _paragraphText(
      {required String title, required String paragraphSentence}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: TextStyle(fontSize: FontSize.subheading)),
        SizedBox(height: SpaceSize.line),
        Text(paragraphSentence, style: TextStyle(fontSize: FontSize.body)),
        SizedBox(height: SpaceSize.paragraph)
      ],
    );
  }
