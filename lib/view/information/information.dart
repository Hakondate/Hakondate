...
class Information extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      appBar: const FadeUpAppBar(title: Text('インフォメーション')),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              DescriptionText.linked(label: '文部科学省 学校給食実施基準', url: 'https://www.mext.go.jp/a_menu/sports/syokuiku/1407704.htm'),
              DescriptionText.linked(label: '文部科学省 日本食品標準成分表', url: 'https://www.mext.go.jp/a_menu/syokuhinseibun/1365420.htm'),
              DescriptionText.linked(label: '函館市の学校給食 給食ひろば', url: 'https://www.city.hakodate.hokkaido.jp/docs/2016012500108/'),
              DescriptionText.linked(label: '函館市の学校給食 食材の産地', url: 'https://www.city.hakodate.hokkaido.jp/docs/2014031600120/'),
              const SizedBox(height: SpaceSize.paragraph),
              ...
              FutureBuilder<String>(
                ...
                builder: (BuildContext context, AsyncSnapshot<String> snapshot) {
                  if (snapshot.hasData) {
                    return DescriptionText.body(label: snapshot.data!);
                  }
              ...
              DescriptionText.body(
                label:
                    '　本サービスは個人のプライバシー，名誉，その他第三者の権利を侵害することのないよう，利用者に関する情報の取り扱いに充分配慮いたします．'
              ...
              DescriptionText.body(label: '公立はこだて未来大学　はこんだて開発チーム', isZeroBottomPadding: true),
              DescriptionText(
                text: Padding(
                  padding: const EdgeInsets.only(left: PaddingSize.minimum),
                  child: RichText(
                    text: TextSpan(
                      style: TextStyle(color: AppColor.text.link, fontFamily: 'MPLUSRounded1c', fontSize: FontSize.body),
